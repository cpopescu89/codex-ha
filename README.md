...
A web-based terminal interface with a Codex CLI. This add-on provides a terminal environment directly in your Home Assistant dashboard, allowing you to use Codex for coding, automation, and configuration tasks.
